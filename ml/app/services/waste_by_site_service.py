...
def forecast_waste_by_site(df, start_year, end_year, columns, standardized=False):
    ...
    if end_year > trained_until:
        ...
        forecasts = {}
        for col in columns:
            model_path = BASE_DIR / f"models/Waste_by_site_of_generations/{col}_linear_model.pkl"
