...
namespace EcoIndicators.Services.MakStat.Indicators.Waste {
    public class WasteService : IWasteService {
        ...
        public WasteService(
                IAmountMunicipalWaste amountMunicipalWaste,
                IWaste_by_site_of_generation By_Site_Of_Generation,
                ICollected_and_generated_municipal_waste collected_And_Generated_Municipal_Waste
